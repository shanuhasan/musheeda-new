...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    ...
    <a href="{{ route('admin.services.create') }}" class="inline-flex items-center justify-center gap-2.5 rounded-md bg-brand-500 px-4 py-2 text-center font-medium text-white hover:bg-brand-600 transition-colors">
        <span>
        ...
        <table class="w-full table-auto">
            <thead>
                <tr class="bg-slate-50 text-left dark:bg-slate-800">
                    <th class="min-w-[220px] px-4 py-4 font-medium text-slate-800 dark:text-white xl:pl-5">Service Name</th>
                    <th class="min-w-[150px] px-4 py-4 font-medium text-slate-800 dark:text-white">Status</th>
                    <th class="px-4 py-4 font-medium text-slate-800 dark:text-white">Sort Order</th>
                ...
                <tr>
                    ...
                    <td class="border-b border-slate-200 px-4 py-5 pr-5 text-right dark:border-slate-800">
                        <div class="flex items-center justify-end space-x-3">
                            <a href="{{ route('admin.services.edit', $service) }}" class="text-brand-500 hover:text-brand-600">
