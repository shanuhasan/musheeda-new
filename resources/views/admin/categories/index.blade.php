...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    <div>
        <h2 class="text-title-md2 font-bold text-slate-800 dark:text-white/90">Categories</h2>
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Manage blog categories.</p>
    </div>
    <a href="{{ route('admin.categories.create') }}" class="inline-flex items-center justify-center gap-2.5 rounded-lg bg-brand-500 px-4 py-2 text-center font-medium text-white hover:bg-brand-600 lg:px-4 xl:px-6">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm font-medium text-slate-900 dark:text-white/90">{{ $category->name }}</div>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('admin.categories.edit', $category) }}" class="text-brand-600 hover:text-brand-900 dark:text-brand-500 dark:hover:text-brand-400" title="Edit">
                ...
                <tr>
                    <td colspan="3" class="px-6 py-12 text-center text-slate-500 dark:text-slate-400">
                        <h3 class="mt-2 text-sm font-medium text-slate-900 dark:text-white/90">No categories</h3>
                    </td>
                </tr>
                @endforelse
            </tbody>
