...
class VerifySubscriptionNotification extends Notification implements ShouldQueue
{
    ...
    {
        $verificationUrl = route('newsletter.verify', ['token' => $notifiable->token]);

        return (new MailMessage)
                    ->subject('Verify Your Newsletter Subscription')
                    ->greeting('Hello!')
                    ->line('Thank you for subscribing to our newsletter.')
                    ->line('Please click the button below to verify your email address and complete your subscription.')
